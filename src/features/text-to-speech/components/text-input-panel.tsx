...
import { VoiceSelectorButton } from "@/features/text-to-speech/components/voice-selctor-button";
  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col">
      <div className="relative min-h-0 flex-1">
        <form.Field name="text">
          {(field) => (
            <Textarea
              ...
              className="absolute inset-0 resize-none border-0 bg-transparent p-4 pb-6 text-base! leading-relaxed tracking-tight shadow-none wrap-break-word focus-visible:ring-0 focus-visible:ring-offset-0 lg:p-6 lg:pb-8"
        ...
        {text.length > 2175 && (
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-10 bg-linear-to-t from-background via-[#c084fc]/10 to-transparent" />
        )}
      </div>
